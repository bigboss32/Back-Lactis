...
# La hora que ordena los hechos vive en `app/common/models.py` desde que la
# BITÁCORA la necesitó también: el porqué (y lo que pasa cuando dos filas
# empatan) está escrito allá, en `HoraDeRegistroMixin`.
